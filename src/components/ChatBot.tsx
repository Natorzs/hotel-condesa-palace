...
const N8N_ENDPOINT = const N8N_ENDPOINT = "https://uninstilled-aaliyah-guilelessly.ngrok-free.dev/webhook-test/chat-hotel";
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const botMessage: Message = {
        id: Date.now().toString(),
        type: "bot",
        text: data.message || data.response || "No entendí tu mensaje. ¿Podrías intentar de nuevo?",
        timestamp: new Date(),
      };
